...
public class BookcoverService {
    ...
    public BookcoverService(@Value("${my.upload_location}") String fileStorageLocation, FileUploadRepository repo) throws IOException {
    ...
    public String storeFile(MultipartFile file) throws IOException {
        ...
        repo.save(new Bookcover(fileName));
        return fileName;
    }
